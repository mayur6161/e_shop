        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Admin",
                style: TextStyle(color: kBackgroundColor, fontSize: 28.0, fontWeight: FontWeight.bold),
              ),
            ),
            Form(
              key: _formKey,
            ...
            FlatButton.icon(
              ...
              icon: (Icon(Icons.nature_people, color: kPrimaryColor,)),
              label: Text("i'm not Admin", style: TextStyle(color: kPrimaryColor, fontWeight: FontWeight.bold),),
            ),
            SizedBox(
              height: 50.0,
            ),
